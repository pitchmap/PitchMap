...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SPECIAL_VENUE_MAP = {
        ...
        '기산공원':              '기산공원 부산 사상구',
        // 부산 신규 공공구장
        '다대풋살센터':                '다대풋살센터 부산 사하구',
        '오륜동 인조잔디구장':         '오륜동 인조잔디구장 강서구',
        '영도마린축구장':              '영도마린축구장 동삼동',
        '동읍주민운동장':              '동읍주민운동장 기장군',
        // 부산 공공+상업 구장 (Plab)
    ...
    const VENUE_HARDCOORDS = {
        ...
        '다대풋살센터':              { lat: 35.0614, lng: 128.9639 },  // 사하구 다대동
        '오륜동 인조잔디구장':       { lat: 35.1050, lng: 128.8420 },  // 강서구 오륜동
        '영도마린축구장':            { lat: 35.0720, lng: 129.0790 },  // 영도구 동삼동 해양로 307
        '동읍주민운동장':            { lat: 35.2130, lng: 129.1780 },  // 기장군 동읍
        // 경남
